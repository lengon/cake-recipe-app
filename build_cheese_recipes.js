...
const cheeseRecipes = {
  "cheese_p33_peacock_cookie_base": {
    "id": "cheese_p33_peacock_cookie_base",
    "isCustom": true,
    "name": "孔雀餅乾底",
    "englishName": "Peacock Cookie Base",
    "description": "[頁碼] 第 33 頁 | 基礎底材 (1個底)",
    "basePan": { "shape": "custom", "size": "1", "unit": "base" },
    "tips": ["取1張比空心模具大的鋁箔紙，將模具的底部和側邊包覆好備用。"],
    "ingredients": [
      { "category": "base", "name": "市售孔雀餅乾", "baseValue": 70, "unit": "g" },
      { "category": "wet", "name": "無鹽奶油", "baseValue": 30, "unit": "g" }
    ],
    "instructions": [
      { "step": 1, "text": "將餅乾以食物調理機打碎；無鹽奶油融化，備用。" },
      { "step": 2, "text": "將奶油液倒入餅乾碎中，拌勻。" },
      { "step": 3, "text": "放入空心模具鋪平並壓緊實，冷凍半小時即為餅乾底。" }
    ]
  },
  ...
  "cheese_p35_puffed_rice_sesame_crust": {
    "id": "cheese_p35_puffed_rice_sesame_crust",
    "isCustom": true,
    "name": "米香芝麻底",
    ...
    "ingredients": [
      ...
      { "category": "wet", "name": "無鹽奶油", "baseValue": 40, "unit": "g" }
    ],
    "instructions": [
      { "step": 1, "text": "白芝麻粒及米果放入烤盤，以100℃／100℃烘烤15分鐘至熟。" },
      { "step": 2, "text": "將芝麻粒與米果混合均勻後，加入融化的無鹽奶油拌勻。" },
      { "step": 3, "text": "壓入模具中，冷凍半小時即可。" }
    ]
  },
  "cheese_p36_plain_sponge_cake": {
    "id": "cheese_p36_plain_sponge_cake",
    "isCustom": true,
    "name": "原味海綿蛋糕",
    ...
    "ingredients": [
      ...
      { "category": "dry", "name": "低筋麵粉", "baseValue": 82, "unit": "g" },
  ...
  "cheese_p40_french_tart_crust": {
    "id": "cheese_p40_french_tart_crust",
    "isCustom": true,
    "name": "法式塔皮",
    "englishName": "French Tart Crust",
    "description": "[頁碼] 第 40-41 頁 | 直徑7cm空塔皮大約6個",
    "basePan": { "shape": "round", "size": "7", "unit": "cm" },
    "tips": ["材料恢復常溫，冷藏30分鐘後桿成0.3cm厚片狀。"],
    "ingredients": [
      { "category": "wet", "name": "無鹽奶油", "baseValue": 50, "unit": "g" },
      { "category": "dry", "name": "糖粉", "baseValue": 60, "unit": "g" },
      { "category": "dry", "name": "杏仁粉", "baseValue": 22, "unit": "g" },
      { "category": "flavor", "name": "鹽", "baseValue": 1, "unit": "g" },
      { "category": "wet", "name": "全蛋", "baseValue": 35, "unit": "g" },
  ...
  "cheese_p42_easy_tart_crust": {
    ...
    "ingredients": [
      ...
      { "category": "dry", "name": "杏仁粉", "baseValue": 66, "unit": "g" },
      { "category": "flavor", "name": "鹽", "baseValue": 3, "unit": "g" },
      { "category": "dry", "name": "低筋麵粉", "baseValue": 195, "unit": "g" },
      { "category": "flavor", "name": "檸檬粉", "baseValue": 15, "unit": "g" },
  ...
  "cheese_p52_kyoto_matcha_heavy_cheesecake": {
    "id": "cheese_p52_kyoto_matcha_heavy_cheesecake",
    "isCustom": true,
    "name": "京都抹茶重乳酪蛋糕",
    "englishName": "Kyoto Matcha Heavy Cheesecake",
    "description": "[頁碼] 第 52-53 頁 | 方形模具1個 (三能SN3305)",
  ...
  "cheese_p59_landscape_cheesecake": {
    "id": "cheese_p59_landscape_cheesecake",
    "isCustom": true,
    "name": "山水潑墨生乳酪蛋糕",
    "englishName": "Landscape Splash-Ink Raw Cheesecake",
    "description": "[頁碼] 第 59-61 頁 | 15cm圓形框1個",
  ...
  "cheese_p65_new_york_cheesecake": {
    "id": "cheese_p65_new_york_cheesecake",
    "isCustom": true,
    "name": "基礎紐約乳酪蛋糕",
  ...
  "cheese_p69_double_cheese_cake": {
    "id": "cheese_p69_double_cheese_cake",
    "isCustom": true,
    ...
    "ingredients": [
      ...
      { "category": "wet", "name": "酸奶油", "baseValue": 130, "unit": "g" },
      { "category": "wet", "name": "全蛋", "baseValue": 52, "unit": "g" },
      { "category": "flavor", "name": "檸檬汁", "baseValue": 20, "unit": "g" },
  ...
  "cheese_p73_vanilla_sour_cream_snow": {
    "id": "cheese_p73_vanilla_sour_cream_snow",
    "isCustom": true,
    "name": "香草酸奶白雪乳酪蛋糕",
    "englishName": "Vanilla Sour Cream Snow Cheesecake",
    "description": "[頁碼] 第 73-75 頁 | 橢圓模具10個 (6.8x4.6x2.5cm)",
    ...
    "ingredients": [
      ...
      { "category": "wet", "name": "牛奶", "baseValue": 30, "unit": "g" },
      { "category": "flavor", "name": "香草莢", "baseValue": 0.5, "unit": "根" },
  ...
  "cheese_p77_hazelnut_streusel_cheesecake": {
    "id": "cheese_p77_hazelnut_streusel_cheesecake",
    "isCustom": true,
    "name": "榛果奶酥乳酪蛋糕",
    "englishName": "Hazelnut Streusel Cheesecake",
    "description": "[頁碼] 第 77-79 頁 | 15cm方形模1個",
  ...
  "cheese_p81_taro_heavy_cheesecake": {
    "id": "cheese_p81_taro_heavy_cheesecake",
    "isCustom": true,
    "name": "芋頭重乳酪蛋糕",
    "englishName": "Taro Heavy Cheesecake",
    "description": "[頁碼] 第 81-83 頁 | 10cm圓形模具3個",
  ...
  "cheese_p85_puffed_rice_sesame_cheesecake": {
    "id": "cheese_p85_puffed_rice_sesame_cheesecake",
    "isCustom": true,
    "name": "爆米香芝麻乳酪蛋糕",
    "englishName": "Puffed Rice Sesame Cheesecake",
    "description": "[頁碼] 第 85-87 頁 | 12連長方形矽膠模 (7.9x2.9x3cm)",
  ...
  "cheese_p89_peanut_cheesecake": {
    "id": "cheese_p89_peanut_cheesecake",
    "isCustom": true,
    "name": "好事花生乳酪蛋糕",
    "englishName": "Peanut Cheesecake",
    "description": "[頁碼] 第 89-92 頁 | 15連圓柱矽膠模 (3x5.8cm)",
  ...
  "cheese_p93_chocolate_banana_cheesecake": {
    "id": "cheese_p93_chocolate_banana_cheesecake",
    "isCustom": true,
    "name": "巧克力香蕉乳酪蛋糕",
    "englishName": "Chocolate Banana Cheesecake",
    "description": "[頁碼] 第 93-96 頁 | 10cm圓形模具2個",
    "basePan": { "shape": "round", "size": "10", "unit": "cm" },
  ...
  "cheese_p99_honey_sweet_potato_cheesecake": {
    "id": "cheese_p99_honey_sweet_potato_cheesecake",
    "isCustom": true,
    "name": "蜂蜜地瓜乳酪蛋糕",
    "englishName": "Honey Sweet Potato Cheesecake",
    "description": "[頁碼] 第 99-101 頁 | 15連方形矽膠模 (4x4x4cm)",
  ...
  "cheese_p115_tieguanyin_cheesecake": {
    "id": "cheese_p115_tieguanyin_cheesecake",
    "isCustom": true,
    "name": "鐵觀音重乳酪蛋糕",
    "englishName": "Tieguanyin Heavy Cheesecake",
    "description": "[頁碼] 第 115-117 頁 | 橢圓形模具12個 (6.8x4.6x2.5cm)",
    "basePan": { "shape": "custom", "size": "6.8x4.6x2.5", "unit": "cm" },
  ...
  "cheese_p123_basque_cheesecake": {
    "id": "cheese_p123_basque_cheesecake",
    "isCustom": true,
    "name": "巴斯克乳酪蛋糕",
    "englishName": "Basque Cheesecake",
    "description": "[頁碼] 第 123-125 頁 | 15cm圓形2個",
    "basePan": { "shape": "round", "size": "15", "unit": "cm" },
    "tips": ["無底塔皮，高溫190℃烤25分鐘，極致細緻綿密感。"],
    "ingredients": [
      { "category": "wet", "name": "奶油乳酪", "baseValue": 250, "unit": "g" },
      { "category": "dry", "name": "細砂糖", "baseValue": 60, "unit": "g" },
      { "category": "wet", "name": "動物性鮮奶油", "baseValue": 120, "unit": "g" },
      { "category": "wet", "name": "全蛋", "baseValue": 110, "unit": "g" },
      { "category": "dry", "name": "玉米粉", "baseValue": 8, "unit": "g" }
    ],
    "instructions": [
      { "step": 1, "text": "烘焙紙揉爛鋪入圓模成皺褶紙模。" },
      { "step": 2, "text": "奶油乳酪加糖用調理機打軟，加入鮮奶油、全蛋與玉米粉打勻。" },
      { "step": 3, "text": "倒入紙模中消泡，以190℃烤25分鐘，冷藏或冷凍2小時後脫模。" }
    ]
  },
  "cheese_p131_yuzu_jinxuan_cheesecake": {
    "id": "cheese_p131_yuzu_jinxuan_cheesecake",
    "isCustom": true,
    "name": "柚香金萱輕乳酪蛋糕",
    "englishName": "Yuzu Jinxuan Soufflé Cheesecake",
    "description": "[頁碼] 第 131-133 頁 | 12連長方形矽膠模 (7.9x2.9x3cm)",
    "basePan": { "shape": "rectangle", "size": "7.9x2.9x3", "unit": "cm" },
    "tips": ["柚香金萱茶香，輕盈蛋白霜入口即化。160℃水浴烤60分鐘。"],
    "ingredients": [
      { "category": "flavor", "name": "柚香金萱茶粉", "baseValue": 8, "unit": "g" },
      { "category": "wet", "name": "牛奶", "baseValue": 140, "unit": "g" },
      { "category": "wet", "name": "無鹽奶油", "baseValue": 30, "unit": "g" },
      { "category": "flavor", "name": "香草莢", "baseValue": 0.5, "unit": "根" },
      { "category": "dry", "name": "細砂糖 (蛋黃糊)", "baseValue": 21, "unit": "g" },
      { "category": "wet", "name": "蛋黃", "baseValue": 60, "unit": "g" },
      { "category": "wet", "name": "奶油乳酪", "baseValue": 200, "unit": "g" },
      { "category": "dry", "name": "低筋麵粉", "baseValue": 12, "unit": "g" },
      { "category": "wet", "name": "蛋白 (冷藏)", "baseValue": 55, "unit": "g" },
  ...
  "cheese_p180_rice_crispy_bar": {
    "id": "cheese_p180_rice_crispy_bar",
    "isCustom": true,
    "name": "米果蹦蹦乳酪條",
    "englishName": "Rice Crispy Cheese Bar",
    "description": "[頁碼] 第 180-181 頁 | 12連長方形矽膠模 (7.9x2.9x3cm)",
    "basePan": { "shape": "rectangle", "size": "7.9x2.9x3", "unit": "cm" },
    ...
    "ingredients": [
      ...
      { "category": "dry", "name": "草莓果乾", "baseValue": 40, "unit": "g" },
      { "category": "flavor", "name": "義式蛋白霜", "baseValue": 200, "unit": "g", "note": "參考P.47" }
    ],
    "instructions": [
  ...
  "cheese_p182_matcha_mascarpone_pudding": {
    "id": "cheese_p182_matcha_mascarpone_pudding",
    "isCustom": true,
    "name": "抹茶馬斯卡彭布丁",
    "englishName": "Matcha Mascarpone Pudding",
    "description": "[頁碼] 第 182-184 頁 | 120c.c.鋁合金布丁杯5杯",
    "basePan": { "shape": "round", "size": "120", "unit": "ml" },
    "tips": ["馬斯卡彭乳酪基底，過篩2次，150℃蒸烤65分鐘。"],
    "ingredients": [
      { "category": "wet", "name": "牛奶", "baseValue": 250, "unit": "g" },
      { "category": "wet", "name": "動物性鮮奶油", "baseValue": 250, "unit": "g" },
      { "category": "dry", "name": "細砂糖 (A料)", "baseValue": 60, "unit": "g" },
      { "category": "flavor", "name": "抹茶粉", "baseValue": 7.5, "unit": "g" },
      { "category": "wet", "name": "全蛋", "baseValue": 125, "unit": "g" },
      { "category": "dry", "name": "細砂糖 (B料)", "baseValue": 60, "unit": "g" },
  ...
  "cheese_p197_little_lemon": {
    "id": "cheese_p197_little_lemon",
    "isCustom": true,
    "name": "乳酪小檸檬",
    ...
    "ingredients": [
      { "category": "wet", "name": "無鹽奶油", "baseValue": 60, "unit": "g" },
      { "category": "wet", "name": "奶油乳酪", "baseValue": 60, "unit": "g" },
      { "category": "dry", "name": "糖粉", "baseValue": 115, "unit": "g" },
      { "category": "flavor", "name": "檸檬皮屑", "baseValue": 2, "unit": "顆" },
  ...
  "cheese_p209_soft_lemon_tart": {
    "id": "cheese_p209_soft_lemon_tart",
    "isCustom": true,
    "name": "綿綿乳酪檸檬塔",
    "englishName": "Soft Cheese Lemon Tart",
    "description": "[頁碼] 第 209-211 頁 | 直徑5cm (6連矽膠模)",
    "basePan": { "shape": "round", "size": "5", "unit": "cm" },
    "tips": ["檸檬乳酪糊降溫至20℃倒半圓模，蓋上烤好塔皮150℃烤13-15分鐘。"],
    "ingredients": [
  ...
  "cheese_p214_apple_cheese_tart": {
    "id": "cheese_p214_apple_cheese_tart",
    "isCustom": true,
    "name": "蜜蘋果乳酪塔",
    "englishName": "Honey Apple Cheese Tart",
    "description": "[頁碼] 第 214-217 頁 | 橢圓菊花塔2個 (10.5x8.1x2.9cm)",
  ...
  "cheese_p226_rum_raisin_shortbread": {
    "id": "cheese_p226_rum_raisin_shortbread",
    "isCustom": true,
    "name": "蘭姆葡萄夾心酥餅",
    "englishName": "Rum Raisin Cheese Shortbread",
    "description": "[頁碼] 第 226-229 頁 | 4x4cm正方形6組",
    "basePan": { "shape": "square", "size": "4x4", "unit": "cm" },
    "tips": ["奶油乳酪酥餅，義式蛋白霜奶油霜餡，夾心酒漬葡萄乾。"],
    "ingredients": [
...
// 1. Write cheese_recipes.json
const cheeseJsonPath = path.join(cakeDir, 'cheese_recipes.json');
fs.writeFileSync(cheeseJsonPath, JSON.stringify(cheeseRecipes, null, 2), 'utf-8');
console.log(`Saved cheese_recipes.json (${Object.keys(cheeseRecipes).length} recipes)`);
...
const updatedCustom = { ...existingCustom, ...cheeseRecipes };
...
const mergedRecipes = { ...existingRecipes, ...cheeseRecipes };
